...
queries_file = '../../Dataset/spelling_error_queries.txt'
...
def main_program(queries_file, query_enrichment,result_folder_path):
    try:
        ...
        if query_enrichment:
            ...
            fileName = os.path.join(result_folder_path, "BM25_Ranking_with_spell_checking.txt")
        ...
        for each_query in queries:
            ...
            if(len(query) > 1):
                ...
                calculate_BM25(query[1],query_id,query_enrichment,result_folder_path,file)
        file.close()
        f.close()
    except Exception as e:
            print(traceback.format_exc())
